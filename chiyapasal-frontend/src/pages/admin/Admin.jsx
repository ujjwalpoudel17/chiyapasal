...
function Admin() {
  ...
  const menu = [
    ...
    { name: "Manage Tables", path: "/admin/tables" },
    { name: "Manage Menus", path: "/admin/menus" },
    { name: "Manage Waiters", path: "/admin/waiters" },
  ...
  <div className="min-h-screen flex bg-gray-100">
    ...
    <aside className="w-64 bg-white shadow-md p-5 h-screen sticky top-0 overflow-y-auto">
      <div className="flex flex-col items-center mb-12 mt-10">
        ...
        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-stone-400">Admin Portal</span>
      </div>
